                  ...
                  <div class="row aboutus-row wow rotateInUpLeft" data-wow-duration="0.4s" data-wow-delay="0.5s">
                        ...
                        <div class="col-lg-4 aboutus-col">
                              ...
                              <div class="aboutus-headline">
                                    <h5>Headline</h5>
                                    <div class="aboutus-paragraph">
                                          <p>Lorem ipsum dolor sit amet, consectetur adipisieniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                    </div>
                              </div>
                        </div>
